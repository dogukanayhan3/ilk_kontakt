...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IlkKontakt.Backend.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("IlkKontakt.Backend.Chat.ChatSession", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("IlkKontakt.Backend.Chat.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("IlkKontakt.Backend.Contact.ContactUs", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("IlkKontakt.Backend.Courses.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("IlkKontakt.Backend.Courses.Enrollment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("IlkKontakt.Backend.Courses.Instructor", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("InstructorUserProfileId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("InstructorUserProfileId");
            ...
            modelBuilder.Entity("IlkKontakt.Backend.UserProfiles.Language", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("IlkKontakt.Backend.UserProfiles.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("IlkKontakt.Backend.UserProfiles.Skill", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("IlkKontakt.Backend.UserProfiles.UserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("IlkKontakt.Backend.Chat.Message", b =>
                {
                    b.HasOne("IlkKontakt.Backend.Chat.ChatSession", "ChatSession")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("IlkKontakt.Backend.Courses.Course", b =>
                {
                    b.HasOne("IlkKontakt.Backend.Courses.Instructor", null)
                        .WithMany()
            ...
            modelBuilder.Entity("IlkKontakt.Backend.Courses.Enrollment", b =>
                {
                    b.HasOne("IlkKontakt.Backend.Courses.Course", null)
                        .WithMany()
            ...
            modelBuilder.Entity("IlkKontakt.Backend.Courses.Instructor", b =>
                {
                    b.HasOne("IlkKontakt.Backend.UserProfiles.UserProfile", null)
                        .WithMany()
                        .HasForeignKey("InstructorUserProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
